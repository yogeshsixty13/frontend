...
//		setMyTaskListGoogleMap( "", "getMyTaskListGoogleMap" );
	...
	if ( isAutoLoadPagination )
		setInterval(auto_increment_pagination, 4000);
    ...
    confirmButton.click(function(e) 
	{
        ...
        if(owner.val().length < 5)
            ...
            alert("Wrong CVV");
        else if ( expireDate.val().length < 5 )
...
$("input[name='sort_by']").click( function(){
	...
	if( selected == "Selected" ) 
		setAllTaskList( "", "getSortByTaskSelectedList" );
	else if( selected == "Pending" ) 
		setAllTaskList( "", "getSortByTaskPendingList" );
	else
		setAllTaskList( "", "getMyTaskList" );
});

$(".fcity-btn").click( function(){
	setAllTaskList( "#task_filter_form", "getMyTaskList" );
});
