...
|
*/
$config['rest_status_field_name'] = 'type';	//On 01-05-2015 changed from 'status'
...
|
*/
$config['rest_message_field_name'] = 'msg';	//On 01-05-2015 changed from 'error'
...
|
*/
$config['rest_valid_logins'] = null; //array('admin' => '1234');
